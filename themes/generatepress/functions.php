...
{
	wp_enqueue_style('frontend1-css', get_template_directory_uri() . '/tailwind/output1.css');
	wp_enqueue_style('frontend2-css', get_template_directory_uri() . '/tailwind/output2.css');
}
